...
typedef struct
{
  ...
  gattBMAlloc_t *gattBMAlloc;        // GATT allocator function
  gattBMFree_t  *gattBMFree;         // GATT de-allocator function
...
//
extern gattBMAlloc_t pfnGattBMAlloc;
extern gattBMFree_t  pfnGattBMFree;
